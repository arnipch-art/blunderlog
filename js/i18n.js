...
const STRINGS = {
  sv: {
    ...
    checkmated: 'matt', resigned: 'gav upp', timeout: 'tiden', abandoned: 'lämnade', lose: 'förlust', vs: 'mot',
    engineFail: 'Stockfish kunde inte startas. Prova att ladda om sidan – och kolla att webbläsaren tillåter WebAssembly.',
    netError: 'Kunde inte nå chess.com just nu. Vänta en stund och försök igen.',
    calibNote: 'accuracy ±{err} % mot chess.com ({n} partier)',
    ...
    startPos: 'Startställning', you: 'du', isLabel: 'är {label}', wasBest: '{best} var bäst.', clickMove: 'Klicka på ett drag eller använd ← →.',
    brilliantWhy: 'Ett offer som håller – pjäsen kan slås, men ställningen är fortfarande bra.', greatWhy: 'Enda bra draget i ställningen – allt annat tappar tydligt.',
  ...
  en: {
    ...
    checkmated: 'checkmate', resigned: 'resignation', timeout: 'time', abandoned: 'abandoned', lose: 'loss', vs: 'vs',
    engineFail: 'Stockfish could not start. Try reloading the page, and check that your browser allows WebAssembly.',
    netError: 'Could not reach chess.com right now. Wait a moment and try again.',
    calibNote: 'accuracy ±{err} % vs chess.com ({n} games)',
    ...
    startPos: 'Starting position', you: 'you', isLabel: 'is {label}', wasBest: '{best} was best.', clickMove: 'Click a move or use ← →.',
    brilliantWhy: 'A sacrifice that works – the piece can be taken, but the position still holds.', greatWhy: 'The only good move – everything else loses clearly.',
